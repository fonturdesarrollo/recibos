					...
					<tr>
						...
						<td class='auto'>
							<p id="selecciona_nomina">
								<select name="tipo_nomina" id="tipo_nomina" title="Seleccione el tipo de nómina a consultar." onchange="recibo_dinamico();">
					...
					<tr>
						...
						<td class='auto'>
							<p id="selecciona_fecha">
								<select name='año_quincena' id="año_quincena" title="Seleccione de la lista desplegable la quincena del recibo que desea emitir"  onchange="recibo_dinamico();"">
								...
								<select id="mes_quincena" name='mes_quincena' title="Seleccione de la lista desplegable la quincena del recibo que desea emitir"  onchange="recibo_dinamico();">
									<option selected='selected'></option>
